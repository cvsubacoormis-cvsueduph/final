      ...
      <div className="grid grid-cols-2 gap-4 mb-4 space-x-4">
        ...
        <div className="col-span-2 sm:col-span-1 pl-10">
          <div className="grid grid-cols-3 gap-x-1">
            ...
            <p className="font-semibold mt-2 text-sm whitespace-nowrap">
              Academic Year:
            </p>
            <p className="col-span-2 mt-2 text-sm">
      ...
      <table className="min-w-full bg-white border-l border-r border-b">
        <thead>
          <tr className="border-t">
            <th className="px-4 border-b border-l border-r font-medium text-gray-700 text-sm">
              Code
            </th>
            <th className="px-4 border-b border-r font-medium text-gray-700 text-sm">
              Units
            </th>
            <th className="px-4 border-b border-r font-medium text-gray-700 text-sm">
              Course Title
      ...
      <div className="mt-10">
        <div className="grid grid-cols-2">
          ...
          <table className="min-w-full ml-20">
            <tbody>
              <tr>
                <td className="py-1 px-2 font-semibold text-sm">
              ...
              <tr>
                ...
                <td className="py-1 px-2 text-sm">
                  {studentInfo.courses.reduce(
                    (prev, current) => prev + current.units,
                    0
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td className="py-1 px-2 text-sm">
                  {studentInfo.courses.reduce(
                    (prev, current) =>
                      prev + (current.grade !== "" ? current.units : 0),
                    0
                  )}
                </td>
              </tr>
